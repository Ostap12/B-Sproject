...
exports.personalContract = function(req, res) {
  res.render('personalContract.ejs', {
    user: user
  });
};

exports.personalFunction = function(req, res) {
  res.render('personalFunction.ejs', {
    user: user
  });
};

exports.personalDeclarations = function(req, res) {
  res.render('personalDeclarations.ejs', {
    user: user
  });
};
